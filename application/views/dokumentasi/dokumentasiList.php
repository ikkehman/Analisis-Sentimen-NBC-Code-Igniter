    ...
    <button type="button" class="btn btn-default" data-dismiss="modal">Tidak</button>
          ...
          <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url('dokumentasi/add'); ?>" class="btn btn-primary btn-border" style="float: right;">+ Dokumentasi</a>
...
$(document).ready(function() {
  ...
  "ajax": {
                        "url": '<?php echo base_url()?>dokumentasi/json',
                        "type": "POST",
                                        "dataType": "JSON",
                        },
                        "columns": [
...
function bulk_delete()
{
    ...
    if(list_id.length > 0)
    {
        if(confirm('Anda yakin menghapus '+list_id.length+' data?'))
        {
            $.ajax({
                type: "POST",
                data: {id_dokumentasi:list_id},
                url: "<?php echo site_url('dokumentasi/bulk_delete')?>",
...
<script type="text/javascript" language="JavaScript">
 ...
 $('#modal-konfirmasi').on('show.bs.modal', function (event) {
  ...
  modal.find('#hapus-true').attr("href","dokumentasi/delete/"+id);
