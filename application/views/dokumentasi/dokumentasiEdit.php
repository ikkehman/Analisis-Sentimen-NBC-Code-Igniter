        ...
        <div class="row mt-3">
          <div class="col-md-12">
            <div class="form-group">
              <label>Judul </label>
              <input required="required" type="text" class="form-control" name="judul" value="<?php echo $dokumentasi->judul; ?>" >
            </div>
          </div>  
        </div>
                    ...
                    <div class="col-md-3">
                      <div class="input-file input-file-image">
                        <img class="img-upload-preview" width="150" src="<?php echo base_url("assets/images/".$dokumentasi->featured_img) ?>" alt="preview">
                        <input type="file" class="form-control form-control-file" id="uploadImg2" name="featured_img" accept="image/*">
                    ...
                    <div class="form-group">  
          <textarea class="form-control" rows="9" cols="9" id="editordata" name="konten"><?php echo $dokumentasi->konten; ?></textarea>
        </div>
