        ...
        <div class="row mt-3">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input required="required" type="text" class="form-control" name="nama_docs" value="<?php echo $arsip->nama_docs; ?>" >
            </div>
          </div>  
        </div>
                  ...
                  <div class="row mt-3">
                    <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select name="kategori" required="" class="form-control">
                              <option value="<?php echo $arsip->kategori; ?>" selected><?php echo ucwords($arsip->kategori); ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input name="tahun_docs" type="text" class="form-control" id="tahun" required="" value="<?php echo $arsip->tahun_docs; ?>">
                      </div>
                    </div>
                  </div>
                  </div>
