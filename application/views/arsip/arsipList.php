    ...
    <button type="button" class="btn btn-default" data-dismiss="modal">Tidak</button>
          ...
          <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url('arsip/add'); ?>" class="btn btn-primary btn-border" style="float: right;">+ Arsip</a>
...
$(document).ready(function() {
  ...
  "ajax": {
                        "url": '<?php echo base_url()?>arsip/json',
                        "type": "POST",
                                        "dataType": "JSON",
                        },
                        "columns": [
...
<script type="text/javascript" language="JavaScript">
 ...
 $('#modal-konfirmasi').on('show.bs.modal', function (event) {
  ...
  modal.find('#hapus-true').attr("href","./delete/"+id);
