    ...
    <div class="card-header">
      ...
      <div class="card-content">
        ...
        <input name="dari" type="text" class="form-control" required="" hidden value="<?php echo($this->session->userdata('username')) ?>">

          <div class="form-group col-md-12 select2-input">
              <label for="exampleFormControlSelect1">Pelanggaran</label>
              <select required="required" id="pendaftar" name="no_pelang" class="form-control">
          ...
          <div class="col-md-12">
            <div class="form-group">
              <label>Perihal</label>
              <input required="required" type="text" class="form-control" name="perihal" value="">
            </div>
          </div> 

            <div class="form-group">
              <textarea class="form-control" id="summernote" name="isi" rows="3"></textarea>
            </div>

<div class="custom-file">
    <input type="file" name="lamp" class="custom-file-input" id="customFile">
