          ...
          <?php endif; ?>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input name="tp_lahir" type="text" class="form-control" required="">
                          </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <input name="tg_lahir" type="text" class="form-control" id="datepicker" name="datepicker" required="" value="<?php echo set_value('tgl_buka'); ?>">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <input name="pend" type="text" class="form-control" value="S1" required="">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                            ...
                            <div class="input-file input-file-image">
                              ...
                              <input type="file" class="form-control form-control-file" id="uploadImg" name="foto_caleg" accept="image/*" required="">
                        ...
                        <div class="col-md-8 ml-auto mr-auto">
                          <div class="form-group select2-input">
                            ...
                            <select required="required" id="pendaftar" name="id_partai" class="form-control">
                              <option value="" selected disabled>- Pilih Partai Pengusung -</option>
                          ...
                          <div class="form-group">
                            <label>No. Urut</label>
                            <input type="text" maxlength="12" class="form-control input-default" id="telp" name="no_urutcal" onkeypress="return isNumber(event)" value="" required="required"/>
                          </div>
                          ...
                          <div class="form-group select2-input">
                            ...
                            <div class="form-group">
                              <label>Tahun</label>
                              <div class="input-group">
                                <input name="tahun_caleg" type="text" class="form-control" id="tahun" required="required" value="2019">
                              </div>
                            </div>

                          <div class="form-group">
                          <label>Motivasi</label>
                          <textarea class="form-control" name="motivasi" rows="3" ></textarea>
                        </div>
