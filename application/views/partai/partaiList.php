    ...
    <button type="button" class="btn btn-default" data-dismiss="modal">Tidak</button>
          ...
          <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url('partai/add'); ?>" class="btn btn-primary btn-border" style="float: right;">+ Partai</a>
...
$(document).ready(function() {
  ...
  "ajax": {
                        "url": '<?php echo base_url('partai/json') ?>',
                        "type": "POST",
                                        "dataType": "JSON",
                        },
                        "columns": [
...
<script type="text/javascript" language="JavaScript">
 ...
 $('#modal-konfirmasi').on('show.bs.modal', function (event) {
  ...
  modal.find('#hapus-true').attr("href","partai/delete/"+id);
