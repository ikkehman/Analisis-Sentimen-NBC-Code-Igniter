      ...
      <div class="card-content">
        ...
        <div class="row mt-3">
          <div class="col-md-12">
            ...
            <label>Kata Awal</label>
              <input required="required" type="text" class="form-control" name="upnormal" value="<?php echo $normalisasi->upnormal; ?>" >
              <label>Kata Normalisasi</label>
              <input required="required" type="text" class="form-control" name="normal" value="<?php echo $normalisasi->normal; ?>" >
            </div>
          </div>  
        </div>
