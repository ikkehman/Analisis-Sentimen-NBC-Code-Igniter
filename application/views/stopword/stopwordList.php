    ...
    <button type="button" class="btn btn-default" data-dismiss="modal">Tidak</button>
          ...
          <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url('stopword/add'); ?>" class="btn btn-primary btn-border" style="float: right;">+ Kata</a>
...
$(document).ready(function() {
  ...
  "ajax": {
                        "url": '<?php echo base_url()?>stopword/get_json',
                        "type": "POST",
                                        "dataType": "JSON",
                        },
                        "columns": [
    ...
    if(list_id.length > 0)
    {
        if(confirm('Anda yakin menghapus '+list_id.length+' data?'))
        {
            $.ajax({
                ...
                url: "<?php echo site_url('partai/bulk_delete')?>",
...
<script type="text/javascript" language="JavaScript">
 ...
 $('#modal-konfirmasi').on('show.bs.modal', function (event) {
  ...
  modal.find('#hapus-true').attr("href","stopword/delete/"+id);
